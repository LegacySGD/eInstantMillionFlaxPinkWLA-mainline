...
public class MillionFlaxPinkWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MillionFlaxPinkWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MillionFlaxPinkWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MillionFlaxPinkWLAIW/InitOutcome.xml").getDocumentElement();
